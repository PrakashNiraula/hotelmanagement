        ...
        private async void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (command.ToLower() == "view")
            {
               ...
               res2 = await getbillcontet;
                ...
                PrintBill pb = new PrintBill(records,dr["guest_name"].ToString(),dr["billtype"].ToString(),dr["description"].ToString(),dr["advance"].ToString(),dr["number"].ToString(), "Bill no: A"+billid.ToString(),dr["service_charge"].ToString(),dr["vat"].ToString(), dr["panorvat"].ToString());
                pb.ShowDialog();
                records.Clear();
